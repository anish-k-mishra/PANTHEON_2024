...
const Carousel = () => {
  return (
    <div className="bg-neutral-800 p-4">
      <h2 className="text-center text-4xl md:text-6xl font-bold bg-gradient-to-r from-indigo-600 to-blue-400 bg-clip-text text-transparent text-white">
        ARCHIVES
      </h2>
...
const Card = ({ card }) => {
  return (
    <div
      key={card.id}
      className="group relative h-[300px] sm:h-[400px] md:h-[450px] w-[300px] sm:w-[400px] md:w-[450px] overflow-hidden bg-neutral-200"
    >
